...
\begin{enumerate}[label=(\Alph*)]
    ...
    \item The viscous term in the Navier–Stokes $\to$ Schrödinger–Pauli mapping is represented by an effective local imaginary potential $V_I(\mathbf{x},\tau)$ as in Eq.~\eqref{eq:HE_decomp}, valid in the coarse-grained semiclassical limit.
